...
def convert_from_image_to_tensor(img):
    """
    input :
    img : une image ou un np.array(image) , torch.from_numpy(image) de taille []
    """
    #trans en nv de gris car sinon donne 4 img de chaque channel, alors le le channel reste 1
